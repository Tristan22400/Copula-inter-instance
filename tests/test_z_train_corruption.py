"""
test_z_train_corruption.py — Sanity checks for data_gen.py::corrupt_z_train,
the z_train robustness augmentation (see its docstring / conf/data/gp_tasks.yaml's
